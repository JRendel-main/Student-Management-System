...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2024 at 07:18 PM
...
CREATE TABLE `grades` (
  ...
  `quarterly_grade` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `grade_componennt`
--

CREATE TABLE `grade_componennt` (
...
--
-- Indexes for table `grade_componennt`
--
ALTER TABLE `grade_componennt`
...
--
-- AUTO_INCREMENT for table `grade_componennt`
--
ALTER TABLE `grade_componennt`
