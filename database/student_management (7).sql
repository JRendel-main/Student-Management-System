...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2024 at 06:46 PM
...
INSERT INTO `final_grade` (`final_id`, `student_id`, `subject_id`, `semester_id`, `final_grade`, `remark`) VALUES
(1, 2, 13, 1, 0, NULL),
(2, 4, 12, 1, 62, NULL),
(3, 2, 12, 1, 97, NULL),
(4, 4, 12, 3, 20, NULL),
...
--
ALTER TABLE `final_grade`
  MODIFY `final_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `grades`
--
ALTER TABLE `grades`
  MODIFY `grades_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
